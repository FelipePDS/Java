...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setForeground(new java.awt.Color(218, 214, 233));
        jLabel4.setText("Senha");

        user.setBackground(new java.awt.Color(54, 51, 68));
        user.setForeground(new java.awt.Color(218, 214, 233));
        ...
        password.setBackground(new java.awt.Color(54, 51, 68));
        password.setForeground(new java.awt.Color(218, 214, 233));
        ...
        enterButton.setBackground(new java.awt.Color(42, 255, 166));
    ...
    private void enterButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterButtonActionPerformed
        ...
        if (user.getText().equals(usuario.getName()) && password.getText().equals(usuario.getPassword())) {
            JOptionPane.showMessageDialog(null, "OLÁ " + usuario.getName() + "! BEM VINDO AO SISTEMA DE CAIXA ELETRÔNICO!\nVOCÊ PODERÁ:\nVER SALDO | SACAR | DEPOSITAR");
