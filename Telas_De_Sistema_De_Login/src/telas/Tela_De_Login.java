...
public class Tela_De_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(42, 38, 58));
        setResizable(false);
    ...
    private void enterButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterButtonActionPerformed
        ...
        if (user.getText().equals("admin") && password.getText().equals("1234")) {
            JOptionPane.showMessageDialog(null, "BEM VINDO A PARTE RESTRITA DO SISTEMA");
            
            Tela_Principal mainScreen = new Tela_Principal();
